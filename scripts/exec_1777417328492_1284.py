...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777417306209_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is there a car visible in this image? If yes, is it a Toyota? If it is a Toyota, return "toyota". If the car is not a Toyota or there is no car, return the string SKIP.
...
stream_metrics = stream_3.map(MapComputeMetrics("opt_cars_brand_toyota_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_brand_toyota_r854")\
...
env.execute("Optimized Car Brand Toyota (R854)")
