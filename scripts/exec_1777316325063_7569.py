...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777316307966_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is a volleyball spike happening in this image? If yes, return the bounding box of the spiking player as 'x1,y1,x2,y2' (pixel integers). If no spike, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("volleyball_bbox_spike"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_bbox_spike")\
...
env.execute("Spike Bounding Boxes (Window)")
