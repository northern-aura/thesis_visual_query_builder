...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777283352634_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("case_cars_color_plate_red_cfred_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_cars_color_plate_red_cfred_native")\
...
env.execute("Case Color+Plate Red (CFred native)")
