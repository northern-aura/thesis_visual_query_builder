...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776600045229_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("cars_query_car_color_recognition_optimised_skipping"))
...
env.execute("Query Car Brand Recognition")
