...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777635268510_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is there a player setting the ball in this volleyball image? If yes, return 'setting'. If not or no players visible, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_vb_set_count_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_set_count_r854")\
...
env.execute("Optimized Set Count (R854)")
