...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777579792096_0")\
...
stream_2 = stream_1.map(MapPromptLLM("""Is there a player setting the ball in this volleyball image? If yes, return 'setting'. If not or no players visible, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("volleyball_repeated_setters"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_repeated_setters")\
...
env.execute("Repeated Setters (Window)")
