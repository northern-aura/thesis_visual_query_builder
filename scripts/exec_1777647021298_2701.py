...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777647008599_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is there a player jumping in this volleyball image? If yes, return 'jumping'. If not or no players visible, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_vb_players_jumping_r480"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_players_jumping_r480")\
...
env.execute("Optimized Players Jumping (R480)")
