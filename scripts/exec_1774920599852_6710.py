...
stream_3 = stream_2.map(MapPromptLLM("""Is there a red car visible in this image? (do not take into consideration the bumper)? If yes, return "red". If the car is not red or there is no car, return the string SKIP.
