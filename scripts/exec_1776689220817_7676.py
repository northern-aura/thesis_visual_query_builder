...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776689213630_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("cars_plate_grayscale"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_plate_grayscale")\
...
env.execute("License Plates (Grayscale)")
