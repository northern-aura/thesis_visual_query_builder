...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776690419723_0")\
...
stream_4 = stream_3.map(MapChangeFormat()).window_all(TumblingProcessingTimeWindows.of(Time.seconds(10))).reduce(ReduceWindowResults())
...
stream_metrics = stream_6.map(MapComputeMetrics("volleyball_repeated_spikers"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_repeated_spikers")\
...
env.execute("Repeated Spikers (Window)")
