...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777324244742_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("opt_cars_color_plate_red_cfred_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_color_plate_red_cfred_native")\
...
env.execute("Optimized Color+Plate Red (CFred native)")
