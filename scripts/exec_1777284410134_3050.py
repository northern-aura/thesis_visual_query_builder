...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777284400585_0")\
...
stream_metrics = stream_6.map(MapComputeMetrics("case_vb_bbox_spike_r960_b3"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_vb_bbox_spike_r960_b3")\
...
env.execute("Case Spike Bbox (R960+B3)")
