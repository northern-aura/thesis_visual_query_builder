...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777600721438_0")\
...
stream_2 = stream_1.map(MapPromptLLM("""Is there a player jumping in this volleyball image? If yes, return 'jumping'. If not or no players visible, return SKIP.
...
stream_metrics = stream_4.map(MapComputeMetrics("volleyball_players_jumping"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_players_jumping")\
...
env.execute("Players Jumping (Window)")
