...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776689926906_0")\
...
stream_metrics = stream_6.map(MapComputeMetrics("cars_repeating_plates_skip10"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_repeating_plates_skip10")\
...
env.execute("Repeating Plates (Skip 10)")
