...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777647229739_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is there a player blocking at the net in this volleyball image? If yes, return 'blocking'. If not or no players visible, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_vb_block_count_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_block_count_r854")\
...
env.execute("Optimized Block Count (R854)")
