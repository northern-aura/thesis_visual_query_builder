...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777311688416_0")\
...
stream_2 = stream_1.map(MapPromptLLM("""Is there a player digging the ball in this volleyball image? If yes, return 'digging'. If not or no players visible, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("volleyball_repeated_diggers"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_repeated_diggers")\
...
env.execute("Repeated Diggers (Window)")
