...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777634474059_0")\
...
# Procesing Node 2 (frame batcher)
stream_2 = stream_1.map(MapFrameBatcher(4))
# Procesing Node 3 (llm)
stream_3 = stream_2.map(MapPromptLLM("""Is a volleyball block happening at the net in this image? If yes, return the bounding box of the blocking player as 'x1,y1,x2,y2' (pixel integers). If no block, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("volleyball_bbox_block"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_bbox_block")\
...
env.execute("Block Bounding Boxes (Window)")
