...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777284254631_0")\
...
stream_metrics = stream_5.map(MapComputeMetrics("case_vb_motion_category_r480"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_vb_motion_category_r480")\
...
env.execute("Case Motion Category (R480)")
