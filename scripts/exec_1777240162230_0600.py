...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777240146092_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("case_cars_brand_generic_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_cars_brand_generic_r854")\
...
env.execute("Case Car Brand Generic (R854)")
