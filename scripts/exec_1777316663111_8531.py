...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777316639597_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is a volleyball set happening in this image? If yes, return the bounding box of the setting player as 'x1,y1,x2,y2' (pixel integers). If no set, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("volleyball_bbox_set"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_bbox_set")\
...
env.execute("Set Bounding Boxes (Window)")
