...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776740880718_0")\
...
stream_metrics = stream_5.map(MapComputeMetrics("cars_most_popular_brand_skip10"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_most_popular_brand_skip10")\
...
env.execute("Most Popular Brand (Skip 10)")
