...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777332161980_0")\
...
stream_metrics = stream_2.map(MapComputeMetrics("cars_specific_plate_qrf8g17"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_specific_plate_qrf8g17")\
...
env.execute("Specific Plate: QRF8G17")
