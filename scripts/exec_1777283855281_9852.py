...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777283846404_0")\
...
stream_metrics = stream_7.map(MapComputeMetrics("case_vb_repeated_spikers_g_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_vb_repeated_spikers_g_r854")\
...
env.execute("Case Repeated Spikers (G+R854)")
