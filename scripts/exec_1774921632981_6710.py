...
stream_3 = stream_2.map(MapCVColorFilter("cv_color_red", 20))
# Procesing Node 4 (llm)
stream_4 = stream_3.map(MapPromptLLM("""Is there a red car visible in this image? (do not take into consideration the bumper)? If yes, return "red". If the car is not red or there is no car, return the string SKIP.
