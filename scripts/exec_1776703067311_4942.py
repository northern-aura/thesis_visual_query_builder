...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776703060641_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("cars_color_plate_resize"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_color_plate_resize")\
...
env.execute("Color + Plate (Resize)")
