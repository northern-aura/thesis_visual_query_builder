...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776685606304_0")\
...
stream_metrics = stream_6.map(MapComputeMetrics("cars_unique_plates_grayscale"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_unique_plates_grayscale")\
...
env.execute("Unique Plates (Grayscale)")
