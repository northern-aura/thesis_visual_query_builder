...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776681616220_0")\
...
stream_metrics = stream_2.map(MapComputeMetrics("cars_color_plate_red"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_color_plate_red")\
...
env.execute("Color + License Plate (Red)")
