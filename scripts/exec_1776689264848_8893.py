...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776689257438_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is there a license plate visible in this image? If yes, read the license plate text. If the license plate reads "QRF213" (ignoring whitespace), return "QRF213". Otherwise, return the string SKIP.
...
stream_metrics = stream_3.map(MapComputeMetrics("cars_specific_plate_resize"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_specific_plate_resize")\
...
env.execute("Specific Plate (Resize)")
