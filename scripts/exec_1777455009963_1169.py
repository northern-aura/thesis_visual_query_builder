...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777454993475_0")\
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_vb_spike_count_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_spike_count_r854")\
...
env.execute("Optimized Spike Count (R854)")
