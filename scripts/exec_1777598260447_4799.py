...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777598238736_0")\
...
stream_2 = stream_1.map(MapPromptLLM("""Are there players standing still in this volleyball image? Return 'standing' if at least one player is standing, otherwise SKIP.
...
stream_metrics = stream_4.map(MapComputeMetrics("volleyball_players_standing"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_players_standing")\
...
env.execute("Players Standing (Window)")
