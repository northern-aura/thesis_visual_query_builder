...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777654167150_0")\
...
stream_4 = stream_3.map(MapPromptLLM("""Is a volleyball set happening in this image? If yes, return the bounding box of the setting player as 'x1,y1,x2,y2' (pixel integers). If no set, return SKIP.
...
stream_metrics = stream_6.map(MapComputeMetrics("opt_vb_bbox_set_r960_b3_w20"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_bbox_set_r960_b3_w20")\
...
env.execute("Optimized Set Bounding Boxes (R960+B3+W20)")
