...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776707947962_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("cars_most_popular_color_ford"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_most_popular_color_ford")\
...
env.execute("Most Popular Color (Ford)")
