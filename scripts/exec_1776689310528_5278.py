...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776689303272_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("cars_specific_plate_skip10"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_specific_plate_skip10")\
...
env.execute("Specific Plate (Skip 10)")
