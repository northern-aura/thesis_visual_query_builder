...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777322236041_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Is there a license plate visible in this image? If yes, return the text of the license plate in uppercase without any whitespaces. If there is no license plate in the image, return the string SKIP.
...
stream_metrics = stream_3.map(MapComputeMetrics("opt_cars_plate_cfwhite_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_plate_cfwhite_native")\
...
env.execute("Optimized License Plates (CFwhite native)")
