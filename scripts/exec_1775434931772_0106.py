...
stream_2 = stream_1.map(MapPromptLLM("""Is there a car visible in this image? If yes, is the car grey or silver (do not take into consideration the bumper)? If the car is grey or silver, return "grey". If the car is not grey/silver or there is no car, return the string SKIP.
