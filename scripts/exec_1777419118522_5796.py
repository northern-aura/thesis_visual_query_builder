...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777419105402_0")\
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_cars_most_popular_brand_color_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_most_popular_brand_color_r854")\
...
env.execute("Optimized Most Popular Brand+Color (R854)")
