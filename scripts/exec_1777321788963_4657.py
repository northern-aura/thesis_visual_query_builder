...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777321758433_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("opt_cars_color_red_cfred_r480"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_color_red_cfred_r480")\
...
env.execute("Optimized Car Color Red (CFred+R480)")
