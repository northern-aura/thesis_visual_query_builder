...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777419050266_0")\
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_cars_most_popular_color_r480"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_most_popular_color_r480")\
...
env.execute("Optimized Most Popular Color (R480)")
