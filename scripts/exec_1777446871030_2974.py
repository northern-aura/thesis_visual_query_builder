...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777446847754_0")\
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_cars_repeating_plates_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_repeating_plates_native")\
...
env.execute("Optimized Repeating Plates (Native)")
