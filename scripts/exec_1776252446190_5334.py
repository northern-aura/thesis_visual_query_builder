...
stream_2 = stream_1.map(MapSkipFrames(10, 5))
...
stream_metrics = stream_3.map(MapComputeMetrics("cars_color_skip10"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_color_skip10")\
