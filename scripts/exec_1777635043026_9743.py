...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777635027784_0")\
...
stream_3 = stream_2.map(MapPromptLLM("""Are there players standing still in this volleyball image? Return 'standing' if at least one player is standing, otherwise SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("opt_vb_players_standing_r480"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_players_standing_r480")\
...
env.execute("Optimized Players Standing (R480)")
