...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1776754844260_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("cars_unique_plates_window"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("cars_unique_plates_window")\
...
env.execute("Unique License Plates (Window)")
