...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777418881884_0")\
...
stream_metrics = stream_2.map(MapComputeMetrics("opt_cars_plate_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_plate_native")\
...
env.execute("Optimized License Plate Recognition (Native)")
