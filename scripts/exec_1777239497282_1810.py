...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777233603308_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("case_cars_plate_cfwhite_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_cars_plate_cfwhite_native")\
...
env.execute("Case License Plates (CFwhite native)")
