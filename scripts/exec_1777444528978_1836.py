...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777444506880_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("opt_cars_unique_plates_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_unique_plates_native")\
...
env.execute("Optimized Unique Plates (Native)")
