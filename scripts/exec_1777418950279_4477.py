...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777418937394_0")\
...
stream_2 = stream_1.map(MapPromptLLM("""Is there a license plate visible in this image? If yes, read the license plate text. If the license plate reads "QRF8G17" (ignoring whitespace), return "QRF8G17". Otherwise, return the string SKIP.
...
stream_metrics = stream_2.map(MapComputeMetrics("opt_cars_qrf8g17_native"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_cars_qrf8g17_native")\
...
env.execute("Optimized Specific Plate QRF8G17 (Native)")
