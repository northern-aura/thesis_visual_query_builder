...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777450682095_0")\
...
stream_4 = stream_3.map(MapPromptLLM("""Is there a player setting the ball in this volleyball image? If yes, return 'setting'. If not or no players visible, return SKIP.
...
stream_metrics = stream_7.map(MapComputeMetrics("opt_vb_repeated_setters_g_r854"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_repeated_setters_g_r854")\
...
env.execute("Optimized Repeated Setters (G+R854)")
