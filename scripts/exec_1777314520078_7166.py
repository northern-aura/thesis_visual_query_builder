...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777314504434_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("volleyball_spike_count"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_spike_count")\
...
env.execute("Spike Count (Window)")
