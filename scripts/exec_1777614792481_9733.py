...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777614770664_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("volleyball_block_count"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("volleyball_block_count")\
...
env.execute("Block Count (Window)")
