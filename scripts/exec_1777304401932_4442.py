...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777304384424_0")\
...
stream_2 = stream_1.map(MapPromptLLM("""Is there a player spiking the ball in this volleyball image? If yes, return 'spiking'. If not or no players visible, return SKIP.
...
stream_metrics = stream_5.map(MapComputeMetrics("volleyball_repeated_spikers"))
