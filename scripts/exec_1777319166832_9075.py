...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777319144198_0")\
...
stream_metrics = stream_4.map(MapComputeMetrics("opt_vb_bbox_spike_r960_b3"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("opt_vb_bbox_spike_r960_b3")\
...
env.execute("Optimized Spike Bbox (R960+B3)")
