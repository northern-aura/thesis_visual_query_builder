...
kafka_source = KafkaSource.builder()\
  ...
  .set_group_id("dashboard_1777230258005_0")\
...
stream_metrics = stream_3.map(MapComputeMetrics("case_cars_color_generic_r480"))

kafka_sink = KafkaSink.builder()\
  .set_bootstrap_servers("kafka:9093")\
  .set_record_serializer(KafkaRecordSerializationSchema.builder()\
       .set_topic("case_cars_color_generic_r480")\
...
env.execute("Case Car Color Generic (R480)")
